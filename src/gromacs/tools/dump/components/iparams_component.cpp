...
void printInteractionParameters(t_functype ftype, const t_iparams& iparams, DumpStrategy* strategy)
{
    switch (ftype)
    {
        ...
        case F_TABDIHS:
            ...
            break;
        case F_POLARIZATION:
            strategy->pr_iparam("alpha", "%15.8e", iparams.polarize.alpha);
            break;
        case F_ANHARM_POL:
        ...
        case F_VSITE2:
        case F_VSITE2FD:
            strategy->pr_iparam("a", "%15.8e", iparams.vsite.a); break;
        case F_VSITE3:
        case F_VSITE3FD:
        case F_VSITE3FAD:
