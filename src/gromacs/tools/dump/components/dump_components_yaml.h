...
public:
    ...
    YamlObjectComponent* addYamlObject(const std::string& name, const int index);
    ...
    YamlInlineObject* addYamlInlineObject();
    YamlInlineObject* addYamlInlineObject(const std::string& name);
